...
pub enum IpConntrackStatus {
    ...
    UnchangeableMask = IPS_NAT_DONE_MASK as u32
        | Self::NatMask as u32
...
pub const IPS_NAT_DONE_MASK: u32 =
    IpConntrackStatus::DstNatDone as u32 | IpConntrackStatus::SrcNatDone as u32;
